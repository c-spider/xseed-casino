...
export default function WalletConnector() {
    ...
    return (
        <div className='fixed w-full h-[100vh] top-0 left-0' style={{zIndex: 1000}}>
            ...
            <div className="md:absolute w-full h-full md:w-fit md:h-fit flex flex-col justify-center  top-[20px] right-[50px] p-[20px] bg-white lg:top-[100px] lg:right-[20px] border border-[lightgray] min-w-[280px] md:rounded-[12px] shadow"
                style={{zIndex: 1001}}>
                ...
                { account &&
                    <div className='flex flex-col'>
                        <WalletButton label={'Disconnect'} icon={'/images/wallet/wallet_closed.png'} handleConnect={deactivate}/>
                    </div>
                }
            </div>
        </div>
